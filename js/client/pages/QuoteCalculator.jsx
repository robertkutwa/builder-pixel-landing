...
import { Calculator, Package, MapPin, ArrowRight, Loader2, AlertCircle, CheckCircle, } from "lucide-react";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="delivery-city" placeholder="Boston" value={formData.deliveryLocation.city} onChange={(e) => handleInputChange("deliveryLocation.city", e.target.value)}/>
                  </div>
                  <div>
                    <Label htmlFor="delivery-state">State</Label>
                    <Input id="delivery-state" placeholder="MA" value={formData.deliveryLocation.state} onChange={(e) => handleInputChange("deliveryLocation.state", e.target.value)}/>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                {formData.size.weight > 0 && (<div className="p-3 bg-muted/50 rounded-lg">
              ...
              <Button onClick={calculateQuote} disabled={isLoading} className="w-full btn-primary" size="lg">
                {isLoading ? (<>
        ...
        <div className="space-y-6">
          ...
          {quote && (<Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  <Button onClick={proceedToShipping} className="w-full btn-primary" size="lg">
                    {user ? (<>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                {weightCategories.map((category, index) => (<div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                    <div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                {popularRoutes.map((route, index) => (<div key={index} className="flex items-center justify-between p-3 border rounded-lg cursor-pointer hover:bg-muted/50 transition-colors" onClick={() => {
