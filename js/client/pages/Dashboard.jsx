...
import { Package, Plus, MapPin, Clock, Truck, CheckCircle, XCircle, AlertCircle, Eye, Edit, DollarSign, BarChart3, } from "lucide-react";
        ...
        try {
            ...
            if (parcelsData.success && parcelsData.data) {
                ...
                const calculatedStats = {
                    ...
                    pendingParcels: items.filter((p) => ["pending", "confirmed"].includes(p.status)).length,
                    inTransitParcels: items.filter((p) => ["picked_up", "in_transit", "out_for_delivery"].includes(p.status)).length,
    ...
    return (<div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
        ...
        <div className="mt-4 lg:mt-0">
          <Button onClick={() => navigate("/parcels/new")} className="btn-primary" size="lg">
      ...
      {/* Stats Cards */}
      {stats && (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Button variant="outline" className="h-auto flex flex-col items-center p-6" onClick={() => navigate("/parcels/new")}>
              ...
              <Button variant="outline" className="h-auto flex flex-col items-center p-6" onClick={() => navigate("/quote")}>
              ...
              <Button variant="outline" className="h-auto flex flex-col items-center p-6" onClick={() => navigate("/parcels")}>
          ...
          <Card>
            ...
            <CardContent>
              {isLoading ? (<div className="space-y-4">
                ...
                </div>) : parcels.length > 0 ? (<div className="space-y-4">
                  {parcels.slice(0, 5).map((parcel) => (<div key={parcel.id} className="flex items-center justify-between p-4 border rounded-lg">
                      <div className="flex items-center space-x-4">
                        <div className={cn("p-2 rounded-full", parcel.status === "delivered"
                    ? "bg-success/10"
                    : parcel.status === "cancelled"
                      ...
                      <div className="text-right">
                        <Badge variant="secondary" className={cn("mb-1", parcel.status === "delivered" &&
                    "bg-success/10 text-success", parcel.status === "cancelled" &&
        ...
        <TabsContent value="active" className="space-y-6">
          <Card>
            ...
            .map((parcel) => (<div key={parcel.id} className="border rounded-lg p-6 mb-4 last:mb-0">
                ...
                "bg-primary/10 text-primary")}>
                    ...
                    <div className="flex justify-between items-center">
                      <div className="text-sm text-muted-foreground">
                        {parcel.estimatedDeliveryAt && (<div className="flex items-center space-x-1">
                      ...
                      <div className="space-x-2">
                        <Button variant="outline" size="sm" onClick={() => navigate(`/parcels/${parcel.id}`)}>
                          <Eye className="w-3 h-3 mr-1"/>
                          View Details
                        </Button>
                        {["pending", "confirmed"].includes(parcel.status) && (<Button variant="outline" size="sm">
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {parcels.map((parcel) => (<div key={parcel.id} className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="flex items-center space-x-4">
                      <div className={cn("p-2 rounded-full", parcel.status === "delivered"
                ? "bg-success/10"
                : parcel.status === "cancelled"
