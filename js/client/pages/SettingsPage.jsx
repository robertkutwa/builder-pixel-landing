...
import { Settings, Palette, Monitor, Moon, Sun, Bell, Map, CreditCard, Shield, HelpCircle, CheckCircle, AlertCircle, Save, } from "lucide-react";
            ...
            <CardContent className="space-y-6">
              <div className="space-y-6">
                <div>
                  ...
                  <Select value={defaultMapView} onValueChange={setDefaultMapView}>
                    <SelectTrigger className="mt-2">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch id="status-icons" checked={showStatusIcons} onCheckedChange={setShowStatusIcons}/>
                  </div>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <Switch id="location-data" checked={shareLocationData} onCheckedChange={setShareLocationData}/>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch id="marketing" checked={marketingCommunications} onCheckedChange={setMarketingCommunications}/>
                </div>
              </div>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <Switch id="desktop-notifications" checked={desktopNotifications} onCheckedChange={setDesktopNotifications}/>
                </div>
