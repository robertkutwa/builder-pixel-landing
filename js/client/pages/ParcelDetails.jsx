...
import { Package, MapPin, Clock, User, DollarSign, Calendar, AlertCircle, CheckCircle, XCircle, Truck, ArrowLeft, Edit, Phone, Mail, Weight, Ruler, } from "lucide-react";
    ...
    return (<div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex space-x-2">
          {canEdit() && (<Button variant="outline" onClick={() => navigate(`/parcels/${parcel.id}/edit`)}>
              <Edit className="w-4 h-4 mr-2"/>
              Edit
            </Button>)}
          {canCancel() && (<Button variant="outline" onClick={() => {
      ...
      {/* Real-time Tracking */}
      <ParcelTracking parcel={parcel} onRefresh={fetchParcelDetails} showMap={true} className="mb-8"/>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {parcel.specialInstructions && (<div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                {parcel.customerPhone && (<div className="flex items-center space-x-2 text-sm">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              {parcel.estimatedDeliveryAt && (<div>
                  <div className="text-sm font-medium text-muted-foreground">
                    Estimated Delivery
                  </div>
                  <div className="text-sm">
