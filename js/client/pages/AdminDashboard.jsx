...
import { Package, Clock, CheckCircle, XCircle, AlertCircle, Edit, Eye, Search, RefreshCw, Truck, DollarSign, } from "lucide-react";
...
export default function AdminDashboard() {
    ...
    const updateParcelStatus = async () => {
        ...
        try {
            ...
            const response = await authenticatedFetch(`/api/parcels/${selectedParcel.id}/status`, {
                method: "PUT",
            ...
            if (data.success && data.data) {
                ...
                setParcels((prev) => prev.map((p) => (p.id === selectedParcel.id ? data.data : p)));
    ...
    return (<div className="container mx-auto px-4 py-8">
      ...
      {/* Stats Cards */}
      {stats && (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-6 mb-8">
          <Card>
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1">
                  ...
                  <div className="relative">
                    ...
                    <Input id="search" placeholder="Search by tracking number, customer, or description..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="pl-10"/>
                  </div>
                </div>
          ...
          <Card>
            ...
            <CardContent>
              {isLoading ? (<div className="space-y-4">
                  ...
                  <TableBody>
                    {filteredParcels.map((parcel) => (<TableRow key={parcel.id}>
                        ...
                        <TableCell>
                          <Badge variant="secondary" className={getStatusBadgeVariant(parcel.status)}>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold">
                      ...
                      {stats
            ? (stats.totalRevenue /
                Math.max(stats.deliveredParcels, 1)).toFixed(2)
            : "0.00"}
                    </span>
                  </div>
                  <div className="flex justify-between">
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input id="status-message" placeholder="Add a note about this status update..." value={statusMessage} onChange={(e) => setStatusMessage(e.target.value)}/>
            </div>
          </div>
          <DialogFooter>
            ...
            <Button onClick={updateParcelStatus} disabled={updateLoading} className="btn-primary">
              {updateLoading ? (<>
