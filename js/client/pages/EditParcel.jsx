...
import { Package, MapPin, Save, ArrowLeft, AlertCircle, CheckCircle, X, Trash2, Edit, DollarSign, } from "lucide-react";
export default function EditParcel() {
    ...
    if (!canEdit()) {
        ...
        <Button variant="outline" onClick={() => navigate(`/parcels/${id}`)} className="mt-4">
          <ArrowLeft className="w-4 h-4 mr-2"/>
          View Parcel Details
        </Button>
      </div>);
    ...
    return (<div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex space-x-2">
          {canCancel() && (<Button variant="outline" onClick={() => setCancelDialogOpen(true)} className="text-destructive hover:text-destructive">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  ...
                  <Input id="delivery-address" value={formData.deliveryLocation.address} onChange={(e) => handleInputChange("deliveryLocation.address", e.target.value)}/>
                </div>
                <div>
                  <Label htmlFor="delivery-city">City</Label>
                  <Input id="delivery-city" value={formData.deliveryLocation.city} onChange={(e) => handleInputChange("deliveryLocation.city", e.target.value)}/>
                </div>
                <div>
                  <Label htmlFor="delivery-state">State</Label>
                  <Input id="delivery-state" value={formData.deliveryLocation.state} onChange={(e) => handleInputChange("deliveryLocation.state", e.target.value)}/>
                </div>
                <div>
                  <Label htmlFor="delivery-postal">Postal Code</Label>
                  <Input id="delivery-postal" value={formData.deliveryLocation.postalCode} onChange={(e) => handleInputChange("deliveryLocation.postalCode", e.target.value)}/>
                </div>
                <div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Textarea id="special-instructions" placeholder="Any special handling instructions..." value={formData.specialInstructions} onChange={(e) => handleInputChange("specialInstructions", e.target.value)} rows={3}/>
              </div>
              ...
              <div>
                ...
                <Input id="pickup-scheduled" type="datetime-local" value={formData.pickupScheduledAt} onChange={(e) => handleInputChange("pickupScheduledAt", e.target.value)}/>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <Button onClick={handleSave} disabled={isSaving || !hasChanges} className="w-full btn-primary">
                {isSaving ? (<>
              ...
              <Button variant="outline" onClick={() => navigate(`/parcels/${id}`)} className="w-full">
                Cancel Editing
              </Button>

              {!hasChanges && (<p className="text-xs text-center text-muted-foreground">
                  No changes to save
                </p>)}
            </CardContent>
          </Card>
